...
const METAS = [
  ...
  { id:'m-301-2', id_kpi:'kpi-301', codigo_kpi:'3.01', seq:2, nome:'Custo Base Amêndoa', descricao:'Custo unitário médio da base amêndoa (produção própria + compra)', responsavel:'Roberto Barroso', diretoria:'Alcione Albanesi', tipo_formato:'decimal', unidade_medida:'R$/kg', bom_quando:'Menor', formula_atingimento:'real_sobre_meta', tipo_acumulado:'media', peso:0.3, status:'Ativa', obs:'', ult_at:'30/04/2025', ativo:true },
